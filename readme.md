...
<style>
  ...
  .typewriter {
    ...
    width: 0;
    margin: 0 auto;
    animation: type 4s steps(60, end) 1s normal both;
  }
  .typewriter .bio-line {
  ...
  .typewriter .bio-line:nth-child(1) { animation-delay: 0.2s; }
  .typewriter .bio-line:nth-child(2) { animation-delay: 1.2s; }
  .typewriter .bio-line:nth-child(3) { animation-delay: 2.2s; }
  @keyframes type {
    0% { width: 0; }
    100% { width: 100%; }
  }
  ...
  @keyframes frame-glow {
    0%, 100% { box-shadow: 0 0 15px #ff00ff, 0 0 30px #ff00ff, 0 0 60px #00ffff, 0 0 90px #00ffff; }
    50% { box-shadow: 0 0 20px #00ffff, 0 0 40px #00ffff, 0 0 80px #ff00ff, 0 0 120px #ff00ff; }
  }
</style>
